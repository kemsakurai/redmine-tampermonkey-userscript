...
(function() {
    'use strict';
    var incluedsFieldIds = ['issue_assigned_to_id','issue_category_id','issue_category_id','issue_fixed_version_id','wiki_page_parent_id','add_filter_select'];
    var q=String.fromCharCode(39);
    var s=document.getElementsByTagName('SELECT');
    for(var i=0;i<s.length;i++) {
        if (incluedsFieldIds.indexOf(s[i].id) != -1) {
